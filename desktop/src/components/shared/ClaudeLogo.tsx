...
interface ClaudeLogoProps {
  ...
  interactive?: boolean; // 是否监听鼠标交互，false 则关闭 mousemove 监听
}

const ClaudeLogo: React.FC<ClaudeLogoProps> = ({ className = '', style, onClick, autoAnimate = false, breathe = false, color = '#D97757', maxScale, interactive = true }) => {
