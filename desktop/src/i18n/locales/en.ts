export const en = {
  ...
  'chat.forkBeforeTurn': 'Before this turn',
  'chat.forkAfterTurn': 'After this turn',
  'chat.forkCreating': 'Creating branch…',
  'commandPalette.title': 'Command palette',
  'commandPalette.placeholder': 'Type a command…',
  'commandPalette.searchInput': 'Search commands',
  'commandPalette.sectionSuggested': 'Suggested',
  'commandPalette.sectionPanels': 'Panels',
  'commandPalette.sectionConfigure': 'Configure',
  'commandPalette.sectionApp': 'App',
  'commandPalette.scopeAll': 'All',
  'commandPalette.scopeCommands': 'Commands',
  'commandPalette.scopeConversations': 'Conversations',
  'commandPalette.scopeFiles': 'Files',
  'commandPalette.empty': 'No commands found',
  'chat.toolSliceNotice': 'Showing {shown} of {total} tools',
  'chat.toolSliceLoadMore': 'Load more',
  'chat.toolSliceLoading': 'Loading...',
  'chat.toolSliceRetry': 'Retry',
  'commandPalette.newTask': 'New task',
  ...
  'chat.turnChangesInlineTitle': '{count} file(s) changed',
  'sidePane.tabWorkspace': 'Workspace',
  'sidePane.tabGit': 'Git',
  'sidePane.tabTerminal': 'Terminal',
  'sidePane.tabBrowser': 'Browser',
  'sidePane.tabCode': 'Code',
  'sidePane.close': 'Close',
  'sidePane.loading': 'Loading…',
  'sidePane.gitTitle': 'Git',
  'sidePane.changedFiles': 'file(s) changed',
  'sidePane.viewChangedFiles': 'View changed files',
  'chat.viewingTurn': 'Viewing turn {turn}',
  'chat.jumpBack': 'Jump back',
  ...
  // ─── Tool Activity Summary (Codex-style structured) ──────────────────────
  'toolActivity.createdOne': 'Created a file',
  'toolActivity.createdMany': 'Created {count} files',
  'toolActivity.created': 'created',
  'toolActivity.editedOne': 'Edited a file',
  'toolActivity.editedMany': 'Edited {count} files',
  'toolActivity.edited': 'edited',
  'toolActivity.deletedOne': 'Deleted a file',
  'toolActivity.deletedMany': 'Deleted {count} files',
  'toolActivity.deleted': 'deleted',
  'toolActivity.ranOne': 'Ran a command',
  'toolActivity.ranMany': 'Ran {count} commands',
  'toolActivity.ran': 'ran',
  'toolActivity.exploredOne': 'explored a file',
  'toolActivity.exploredMany': 'explored {count} files',
  'toolActivity.explored': 'explored',
  'toolActivity.searchedOne': 'a search',
  'toolActivity.searchedMany': '{count} searches',
  'toolActivity.searched': 'searched',
  'toolActivity.webSearched': 'Searched the web',
  'toolActivity.webSearchedLower': 'searched the web',
  'toolActivity.agentOne': 'Dispatched an agent',
  'toolActivity.agentMany': 'Dispatched {count} agents',
  'toolActivity.agent': 'dispatched',
  'toolActivity.toolOne': 'Called a tool',
  'toolActivity.toolMany': 'Called {count} tools',
  'toolActivity.tool': 'called',
  'toolActivity.files': 'files',
  'toolActivity.fallback': 'Tool activity',

  // ─── Tasks ──────────────────────────────────────
  'tasks.title': 'Tasks',
  'tasks.toggleSummary': 'Summary',
