...
export const jp: Record<TranslationKey, string> = {
  ...
  'chat.queuedPromptDragHandle': 'Drag to reorder',
  'chat.queuedPromptSendNow': 'Send now',
  'chat.queuedPromptEdit': 'Edit',
  'chat.queuedPromptEditInput': 'Edit queued prompt',
  'chat.queuedPromptDelete': 'Remove',
  'chat.queuedPromptQueued': 'queued',
  'chat.queuedPromptSubmitting': 'sending',
  'chat.queuedPromptGuided': 'guided',
  'chat.queuedPromptAutoRunPaused': 'Auto-run paused',
  'chat.queuedPromptAutoRun': 'Auto-run',
  'chat.queuedPromptContinue': 'Continue',
  'chat.queuedPromptTitle': 'Queued prompts',
  'chat.forkBeforeTurn': 'このターンの前',
  'chat.forkAfterTurn': 'このターンの後',
  'chat.forkCreating': 'ブランチを作成中…',
  'commandPalette.title': 'コマンドパレット',
  'commandPalette.placeholder': 'コマンドを入力…',
  'commandPalette.searchInput': 'コマンドを検索',
  'commandPalette.sectionSuggested': 'おすすめ',
  'commandPalette.sectionPanels': 'パネル',
  'commandPalette.sectionConfigure': '設定',
  'commandPalette.sectionApp': 'アプリ',
  'commandPalette.scopeAll': 'すべて',
  'commandPalette.scopeCommands': 'コマンド',
  'commandPalette.scopeConversations': '会話',
  'commandPalette.scopeFiles': 'ファイル',
  'commandPalette.empty': 'コマンドが見つかりません',
  'chat.toolSliceNotice': '{total} 件中 {shown} 件のツールを表示',
  'chat.toolSliceLoadMore': 'もっと見る',
  'chat.toolSliceLoading': '読み込み中...',
  'chat.toolSliceRetry': '再試行',
  'commandPalette.newTask': '新しいタスク',
  'commandPalette.showSidebar': 'サイドバーを表示',
  'commandPalette.hideSidebar': 'サイドバーを隠す',
  'commandPalette.switchLight': 'ライトモードに切り替え',
  'commandPalette.switchDark': 'ダークモードに切り替え',
  'commandPalette.settings': '設定',
  'chat.turnChangesInlineTitle': '{count} ファイル変更',
  'sidePane.tabWorkspace': 'ワークスペース',
  'sidePane.tabGit': 'Git',
  'sidePane.tabTerminal': 'ターミナル',
  'sidePane.tabBrowser': 'ブラウザ',
  'sidePane.tabCode': 'コード',
  'sidePane.close': '閉じる',
  'sidePane.loading': '読み込み中…',
  'sidePane.gitTitle': 'Git',
  'sidePane.changedFiles': 'ファイル変更',
  'sidePane.viewChangedFiles': '変更ファイルを表示',
  'chat.viewingTurn': 'ターン {turn} を表示中',
  'chat.jumpBack': '戻る',
  ...
  'chat.turnChangesTitle': '{count} 個のファイルを編集済み',
  'chat.turnChangesUndo': '元に戻す',
  'chat.turnChangesReview': 'レビュー',
  ...
  // ─── Tool Activity Summary (Codex スタイル構造化サマリー) ──────────────────────
  'toolActivity.createdOne': 'ファイルを1つ作成しました',
  'toolActivity.createdMany': '{count} 個のファイルを作成しました',
  'toolActivity.created': '作成しました',
  'toolActivity.editedOne': 'ファイルを1つ編集しました',
  'toolActivity.editedMany': '{count} 個のファイルを編集しました',
  'toolActivity.edited': '編集しました',
  'toolActivity.deletedOne': 'ファイルを1つ削除しました',
  'toolActivity.deletedMany': '{count} 個のファイルを削除しました',
  'toolActivity.deleted': '削除しました',
  'toolActivity.ranOne': 'コマンドを1つ実行しました',
  'toolActivity.ranMany': '{count} 個のコマンドを実行しました',
  'toolActivity.ran': '実行しました',
  'toolActivity.exploredOne': 'ファイルを1つ探索しました',
  'toolActivity.exploredMany': '{count} 個のファイルを探索しました',
  'toolActivity.explored': '探索しました',
  'toolActivity.searchedOne': '1回の検索',
  'toolActivity.searchedMany': '{count} 回の検索',
  'toolActivity.searched': '検索しました',
  'toolActivity.webSearched': 'ウェブを検索しました',
  'toolActivity.webSearchedLower': 'ウェブを検索しました',
  'toolActivity.agentOne': 'エージェントを1つ派遣しました',
  'toolActivity.agentMany': '{count} 個のエージェントを派遣しました',
  'toolActivity.agent': '派遣しました',
  'toolActivity.toolOne': 'ツールを1つ呼び出しました',
  'toolActivity.toolMany': '{count} 個のツールを呼び出しました',
  'toolActivity.tool': '呼び出しました',
  'toolActivity.files': 'ファイル',
  'toolActivity.fallback': 'ツールアクティビティ',

  // ─── Tasks ──────────────────────────────────────
  'tasks.title': 'タスク',
  'tasks.toggleSummary': 'サマリー',
  'tasks.empty': 'タスクなし',
  ...
  'session.exportMarkdown': 'Markdown をエクスポート',
  'trace.open': 'Trace',
