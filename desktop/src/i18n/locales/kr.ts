...
export const kr: Record<TranslationKey, string> = {
  ...
  'chat.forkBeforeTurn': '이 턴 이전',
  'chat.forkAfterTurn': '이 턴 이후',
  'chat.forkCreating': '브랜치 생성 중…',
  'commandPalette.title': '명령 팔레트',
  'commandPalette.placeholder': '명령을 입력하세요…',
  'commandPalette.searchInput': '명령 검색',
  'commandPalette.sectionSuggested': '추천',
  'commandPalette.sectionPanels': '패널',
  'commandPalette.sectionConfigure': '구성',
  'commandPalette.sectionApp': '앱',
  'commandPalette.scopeAll': '전체',
  'commandPalette.scopeCommands': '명령',
  'commandPalette.scopeConversations': '대화',
  'commandPalette.scopeFiles': '파일',
  'commandPalette.empty': '명령을 찾을 수 없습니다',
  'chat.toolSliceNotice': '도구 {total}개 중 {shown}개 표시',
  'chat.toolSliceLoadMore': '더 보기',
  'chat.toolSliceLoading': '로딩 중...',
  'chat.toolSliceRetry': '다시 시도',
  'commandPalette.newTask': '새 작업',
  'commandPalette.showSidebar': '사이드바 표시',
  'commandPalette.hideSidebar': '사이드바 숨기기',
  'commandPalette.switchLight': '라이트 모드로 전환',
  'commandPalette.switchDark': '다크 모드로 전환',
  'commandPalette.settings': '설정',
  'chat.turnChangesInlineTitle': '{count}개 파일 변경',
  'sidePane.tabWorkspace': '워크스페이스',
  'sidePane.tabGit': 'Git',
  'sidePane.tabTerminal': '터미널',
  'sidePane.tabBrowser': '브라우저',
  'sidePane.tabCode': '코드',
  'sidePane.close': '닫기',
  'sidePane.loading': '로딩 중…',
  'sidePane.gitTitle': 'Git',
  'sidePane.changedFiles': '파일 변경',
  'sidePane.viewChangedFiles': '변경 파일 보기',
  'chat.viewingTurn': '턴 {turn} 보는 중',
  'chat.jumpBack': '돌아가기',
  ...
  'chat.turnChangesTitle': '{count}개 파일 편집됨',
  'chat.turnChangesUndo': '실행 취소',
  'chat.turnChangesReview': '검토',
  ...
  // ─── Tool Activity Summary (Codex 스타일 구조화 요약) ──────────────────────
  'toolActivity.createdOne': '파일 1개를 만들었습니다',
  'toolActivity.createdMany': '{count}개의 파일을 만들었습니다',
  'toolActivity.created': '만들었습니다',
  'toolActivity.editedOne': '파일 1개를 편집했습니다',
  'toolActivity.editedMany': '{count}개의 파일을 편집했습니다',
  'toolActivity.edited': '편집했습니다',
  'toolActivity.deletedOne': '파일 1개를 삭제했습니다',
  'toolActivity.deletedMany': '{count}개의 파일을 삭제했습니다',
  'toolActivity.deleted': '삭제했습니다',
  'toolActivity.ranOne': '명령 1개를 실행했습니다',
  'toolActivity.ranMany': '{count}개의 명령을 실행했습니다',
  'toolActivity.ran': '실행했습니다',
  'toolActivity.exploredOne': '파일 1개를 탐색했습니다',
  'toolActivity.exploredMany': '{count}개의 파일을 탐색했습니다',
  'toolActivity.explored': '탐색했습니다',
  'toolActivity.searchedOne': '검색 1회',
  'toolActivity.searchedMany': '{count}회 검색',
  'toolActivity.searched': '검색했습니다',
  'toolActivity.webSearched': '웹을 검색했습니다',
  'toolActivity.webSearchedLower': '웹을 검색했습니다',
  'toolActivity.agentOne': '에이전트 1개를 파견했습니다',
  'toolActivity.agentMany': '{count}개의 에이전트를 파견했습니다',
  'toolActivity.agent': '파견했습니다',
  'toolActivity.toolOne': '도구 1개를 호출했습니다',
  'toolActivity.toolMany': '{count}개의 도구를 호출했습니다',
  'toolActivity.tool': '호출했습니다',
  'toolActivity.files': '파일',
  'toolActivity.fallback': '도구 활동',

  // ─── Tasks ──────────────────────────────────────
  'tasks.title': '작업',
  'tasks.toggleSummary': '요약',
  'tasks.empty': '작업 없음',
  ...
  'session.exportMarkdown': 'Markdown 내보내기',
  'trace.open': 'Trace',
