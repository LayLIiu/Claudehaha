...
export const zh: Record<TranslationKey, string> = {
  ...
  'chat.queuedPromptDragHandle': '拖曳以重新排序',
  'chat.queuedPromptSendNow': '立即發送',
  'chat.queuedPromptEdit': '編輯',
  'chat.queuedPromptEditInput': '編輯排隊提示',
  'chat.queuedPromptDelete': '刪除',
  'chat.queuedPromptQueued': '排隊中',
  'chat.queuedPromptSubmitting': '發送中',
  'chat.queuedPromptGuided': '已引導',
  'chat.queuedPromptAutoRunPaused': '自動運行已暫停',
  'chat.queuedPromptAutoRun': '自動運行',
  'chat.queuedPromptContinue': '繼續',
  'chat.queuedPromptTitle': '排隊提示',
  'chat.forkBeforeTurn': '在此輪之前分支',
  'chat.forkAfterTurn': '在此輪之後分支',
  'chat.forkCreating': '正在建立分支…',
  'commandPalette.title': '命令面板',
  'commandPalette.placeholder': '輸入命令…',
  'commandPalette.searchInput': '搜尋命令',
  'commandPalette.sectionSuggested': '推薦',
  'commandPalette.sectionPanels': '面板',
  'commandPalette.sectionConfigure': '配置',
  'commandPalette.sectionApp': '應用',
  'commandPalette.scopeAll': '全部',
  'commandPalette.scopeCommands': '命令',
  'commandPalette.scopeConversations': '對話',
  'commandPalette.scopeFiles': '檔案',
  'commandPalette.empty': '找不到命令',
  'chat.toolSliceNotice': '顯示 {total} 個工具中的 {shown} 個',
  'chat.toolSliceLoadMore': '載入更多',
  'chat.toolSliceLoading': '載入中...',
  'chat.toolSliceRetry': '重試',
  'commandPalette.newTask': '新增任務',
  'commandPalette.showSidebar': '顯示側欄',
  'commandPalette.hideSidebar': '隱藏側欄',
  'commandPalette.switchLight': '切換至淺色模式',
  'commandPalette.switchDark': '切換至深色模式',
  'commandPalette.settings': '設定',
  'chat.turnChangesInlineTitle': '{count} 個檔案已更改',
  'sidePane.tabWorkspace': '工作區',
  'sidePane.tabGit': 'Git',
  'sidePane.tabTerminal': '終端機',
  'sidePane.tabBrowser': '瀏覽器',
  'sidePane.tabCode': '程式碼',
  'sidePane.close': '關閉',
  'sidePane.loading': '載入中…',
  'sidePane.gitTitle': 'Git',
  'sidePane.changedFiles': '個檔案已更改',
  'sidePane.viewChangedFiles': '檢視變更檔案',
  'chat.viewingTurn': '正在檢視第 {turn} 輪',
  'chat.jumpBack': '跳回',
  ...
  'chat.turnChangesTitle': '已編輯 {count} 個檔案',
  'chat.turnChangesUndo': '撤銷',
  'chat.turnChangesReview': '審核',
  ...
  // ─── Tool Activity Summary (Codex 風格結構化摘要) ──────────────────────
  'toolActivity.createdOne': '建立了一個檔案',
  'toolActivity.createdMany': '建立了 {count} 個檔案',
  'toolActivity.created': '建立了',
  'toolActivity.editedOne': '編輯了一個檔案',
  'toolActivity.editedMany': '編輯了 {count} 個檔案',
  'toolActivity.edited': '編輯了',
  'toolActivity.deletedOne': '刪除了一個檔案',
  'toolActivity.deletedMany': '刪除了 {count} 個檔案',
  'toolActivity.deleted': '刪除了',
  'toolActivity.ranOne': '執行了一條命令',
  'toolActivity.ranMany': '執行了 {count} 條命令',
  'toolActivity.ran': '執行了',
  'toolActivity.exploredOne': '探索了一個檔案',
  'toolActivity.exploredMany': '探索了 {count} 個檔案',
  'toolActivity.explored': '探索了',
  'toolActivity.searchedOne': '一次搜尋',
  'toolActivity.searchedMany': '{count} 次搜尋',
  'toolActivity.searched': '搜尋了',
  'toolActivity.webSearched': '搜尋了網頁',
  'toolActivity.webSearchedLower': '搜尋了網頁',
  'toolActivity.agentOne': '派遣了一個代理',
  'toolActivity.agentMany': '派遣了 {count} 個代理',
  'toolActivity.agent': '派遣了',
  'toolActivity.toolOne': '呼叫了一個工具',
  'toolActivity.toolMany': '呼叫了 {count} 個工具',
  'toolActivity.tool': '呼叫了',
  'toolActivity.files': '個檔案',
  'toolActivity.fallback': '工具活動',

  // ─── Tasks ──────────────────────────────────────
  'tasks.title': '任務',
  'tasks.toggleSummary': '切換摘要',
  'tasks.empty': '暫無任務',
