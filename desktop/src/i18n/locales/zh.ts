...
export const zh: Record<TranslationKey, string> = {
  ...
  'chat.queuedPromptDragHandle': '拖拽以重新排序',
  'chat.queuedPromptSendNow': '立即发送',
  'chat.queuedPromptEdit': '编辑',
  'chat.queuedPromptEditInput': '编辑排队提示',
  'chat.queuedPromptDelete': '删除',
  'chat.queuedPromptQueued': '排队中',
  'chat.queuedPromptSubmitting': '发送中',
  'chat.queuedPromptGuided': '已引导',
  'chat.queuedPromptAutoRunPaused': '自动运行已暂停',
  'chat.queuedPromptAutoRun': '自动运行',
  'chat.queuedPromptContinue': '继续',
  'chat.queuedPromptTitle': '排队提示',
  'chat.forkBeforeTurn': '在此轮之前分支',
  'chat.forkAfterTurn': '在此轮之后分支',
  'chat.forkCreating': '正在创建分支…',
  'commandPalette.title': '命令面板',
  'commandPalette.placeholder': '输入命令…',
  'commandPalette.searchInput': '搜索命令',
  'commandPalette.sectionSuggested': '推荐',
  'commandPalette.sectionPanels': '面板',
  'commandPalette.sectionConfigure': '配置',
  'commandPalette.sectionApp': '应用',
  'commandPalette.scopeAll': '全部',
  'commandPalette.scopeCommands': '命令',
  'commandPalette.scopeConversations': '会话',
  'commandPalette.scopeFiles': '文件',
  'commandPalette.empty': '未找到命令',
  'chat.toolSliceNotice': '显示 {total} 个工具中的 {shown} 个',
  'chat.toolSliceLoadMore': '加载更多',
  'chat.toolSliceLoading': '加载中...',
  'chat.toolSliceRetry': '重试',
  'commandPalette.newTask': '新建任务',
  'commandPalette.showSidebar': '显示侧栏',
  'commandPalette.hideSidebar': '隐藏侧栏',
  'commandPalette.switchLight': '切换到浅色模式',
  'commandPalette.switchDark': '切换到深色模式',
  'commandPalette.settings': '设置',
  'chat.turnChangesInlineTitle': '{count} 个文件已更改',
  'sidePane.tabWorkspace': '工作区',
  'sidePane.tabGit': 'Git',
  'sidePane.tabTerminal': '终端',
  'sidePane.tabBrowser': '浏览器',
  'sidePane.tabCode': '代码',
  'sidePane.close': '关闭',
  'sidePane.loading': '加载中…',
  'sidePane.gitTitle': 'Git',
  'sidePane.changedFiles': '个文件已更改',
  'sidePane.viewChangedFiles': '查看变更文件',
  'chat.viewingTurn': '正在查看第 {turn} 轮',
  'chat.jumpBack': '跳回',
  ...
  // ─── Tool Activity Summary (Codex 风格结构化摘要) ──────────────────────
  'toolActivity.createdOne': '创建了一个文件',
  'toolActivity.createdMany': '创建了 {count} 个文件',
  'toolActivity.created': '创建了',
  'toolActivity.editedOne': '编辑了一个文件',
  'toolActivity.editedMany': '编辑了 {count} 个文件',
  'toolActivity.edited': '编辑了',
  'toolActivity.deletedOne': '删除了一个文件',
  'toolActivity.deletedMany': '删除了 {count} 个文件',
  'toolActivity.deleted': '删除了',
  'toolActivity.ranOne': '执行了一条命令',
  'toolActivity.ranMany': '执行了 {count} 条命令',
  'toolActivity.ran': '执行了',
  'toolActivity.exploredOne': '探索了一个文件',
  'toolActivity.exploredMany': '探索了 {count} 个文件',
  'toolActivity.explored': '探索了',
  'toolActivity.searchedOne': '一次搜索',
  'toolActivity.searchedMany': '{count} 次搜索',
  'toolActivity.searched': '搜索了',
  'toolActivity.webSearched': '搜索了网页',
  'toolActivity.webSearchedLower': '搜索了网页',
  'toolActivity.agentOne': '派遣了一个代理',
  'toolActivity.agentMany': '派遣了 {count} 个代理',
  'toolActivity.agent': '派遣了',
  'toolActivity.toolOne': '调用了一个工具',
  'toolActivity.toolMany': '调用了 {count} 个工具',
  'toolActivity.tool': '调用了',
  'toolActivity.files': '个文件',
  'toolActivity.fallback': '工具活动',

  // ─── Tasks ──────────────────────────────────────
  'tasks.title': '任务',
  'tasks.toggleSummary': '切换摘要',
  'tasks.empty': '暂无任务',
